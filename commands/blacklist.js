exports.run = (client, message, args, sql, Discord) => {
  let uAccess = message.guild.roles.find("name", "SAdmin");
  if(!uAccess){
    message.reply("Please make a role named \"SAdmin\" and assign it to yourself to be able to use this command.");
  }else{
