exports.run = (client, message, args, sql) =>{
    let uRole = message.guild.roles.find("name", "SAdmin");
    if(!uRole){
      message.reply("SAdmin Role not found. Please create it and assign it to yourself to be able to access the command.");
    }else{
